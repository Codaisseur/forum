Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "codaisseur-forum_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: 'forum.codaisseur.com', port: 443, protocol: 'https' }
  ...
  config.action_mailer.smtp_settings = {
    ...
    :domain => 'codaisseur.com', # your domain to identify your server when connecting
  }
end
